...
- AWS Signature v4 with **profile and SSO support** — name a profile from `~/.aws/config` and AUK asks your own AWS CLI for credentials at send time (SSO sessions, assumed roles, credential processes all work)
- AWS Signature v4
