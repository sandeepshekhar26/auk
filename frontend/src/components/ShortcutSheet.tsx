      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={close}>
        ...
        >
          <div class="flex items-center justify-between border-b border-neutral-800 px-4 py-3">
            <span class="text-sm font-semibold text-neutral-100">Keyboard shortcuts</span>
            <button
              ...
              <For each={SHORTCUTS}>
                {(s) => (
                  <tr class="border-b border-neutral-800/60 last:border-0">
                    <td class="px-4 py-2 text-neutral-300">{s.description}</td>
                    <td class="px-4 py-2">
                      <div class="flex justify-end gap-1">
                        <For each={s.keys}>
                          {(k) => (
                            <kbd class="rounded border border-neutral-700 bg-neutral-800 px-1.5 py-0.5 font-mono text-xs text-neutral-300">
                              {k}
                            </kbd>
                          )}
                        </For>
          ...
          <div class="border-t border-neutral-800 px-4 py-2 text-xs text-neutral-600">
